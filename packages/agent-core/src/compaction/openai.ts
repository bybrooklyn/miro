...
import { ProviderHttpError } from "@miro/model-client/error";
import { applyCodexResponsesLiteShape } from "@miro/model-client/providers/openai-codex/request-transformer";
import {
	createOpenAICodexCompactionRequestContext,
	createOpenAICodexCompatibilityMetadata,
	getCodexAttestationHeader,
} from "@miro/model-client/providers/openai-codex-responses";
import {
	encodeResponsesToolResultOutput,
	hoistInterleavedResponsesToolBatchMessages,
	parseAzureDeploymentNameMap,
	parseTextSignature,
} from "@miro/model-client/providers/openai-shared";
import { transformMessages } from "@miro/model-client/providers/transform-messages";
import type {
	Api,
	AssistantMessage,
...
} from "@miro/model-client/types";
import {
	getOpenAIResponsesHistoryItems,
	getOpenAIResponsesHistoryPayload,
	normalizeResponsesToolCallId,
	stripOpenAIResponsesOutputOnlyStatusesForReplay,
} from "@miro/model-client/utils";
import { captureOpenAIHttpError } from "@miro/model-client/utils/openai-http";
import {
	...
	OPENAI_HEADERS,
} from "@miro/model-catalog/wire/codex";
import { $env, isRecord, logger, prompt, stringifyJson, structuredCloneJSON } from "@miro/agent-sys";
