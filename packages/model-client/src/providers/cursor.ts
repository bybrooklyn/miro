...
import { classifyModel } from "@miro/model-catalog/compat/taxonomy";
import type {
	ConversationStep,
	CursorRule,
	McpToolDefinition,
...
import {
	...
	toBinary,
	toJson,
} from "@miro/model-catalog/discovery/protobuf";
import { THINKING_EFFORTS } from "@miro/model-catalog/effort";
