import { toClinePassWireModelId } from "@miro/model-catalog/cline-pass-model-id";
import type { Effort } from "@miro/model-catalog/effort";
import { toFirepassWireModelId, toFireworksWireModelId } from "@miro/model-catalog/fireworks-model-id";
import { getSupportedEfforts } from "@miro/model-catalog/model-thinking";
...
} from "@miro/model-catalog/types";
import { parseAlibabaTokenPlanCredential } from "@miro/model-catalog/wire/alibaba-token-plan";
import {
	COREWEAVE_PROJECT_HEADER,
	coreWeaveProjectHeaders,
	hasCoreWeaveProjectHeader,
	removeBlankCoreWeaveProjectHeaders,
} from "@miro/model-catalog/wire/coreweave";
import { parseGitHubCopilotApiKey } from "@miro/model-catalog/wire/github-copilot";
import {
	$env,
	classifyJsonPrefix,
