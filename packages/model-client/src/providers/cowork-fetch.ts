...
function createResponse(message: IncomingMessage, method: string): Response {
	...
	// Vendoring note: node:stream/web's ReadableStream is structurally identical to but nominally
	// distinct from lib.dom's ReadableStream under tsc; Response accepts it fine at runtime.
