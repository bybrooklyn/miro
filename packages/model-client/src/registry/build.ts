 ...
 * {@link ProviderDefinition} the rest of `@miro/model-client` consumes.
 */
import type { CompiledAuthProvider } from "@miro/model-catalog/compat/types";
import { $pickenv } from "@miro/agent-sys";
