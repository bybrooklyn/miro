import type { KnownProvider } from "@miro/model-catalog";
import { authProviders } from "@miro/model-catalog/compat/auth";
import type { AuthProviderId, LoginProviderId } from "@miro/model-catalog/compat/auth-ids";
 ...
 * (`@miro/model-catalog` `rules/auth/*.kdl`) in `/login` display order.
