...
import { fallbackBindings } from "./fallback.js";

export { NativeUnavailableError } from "./fallback.js";
...
// Miro hardfork: a missing addon degrades to bindings that throw on USE, not on import - see
// fallback.js for why.
let nativeBindings;
try {
	nativeBindings = loadNative();
} catch (error) {
	nativeBindings = fallbackBindings(error);
}
